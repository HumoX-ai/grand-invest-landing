...
const Hero = () => {
  ...
  return (
    <div className="mt-14">
      <motion.div
        className="h-[calc(100vh-10rem)] grid items-center grid-cols-1 md:grid-cols-2 gap-4"
        initial={{ x: "-100vw", opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeInOut" }}
      >
        <motion.div
          className="w-full xl:w-10/12 order-last xl:order-first text-center lg:text-start"
          initial={{ x: "-100vw", opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
